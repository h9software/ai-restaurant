...
def chat():
    user_id = 1  # En un caso real, se debería obtener el ID del usuario autenticado
    while True:
        ...
        # Obtención de recomendaciones (esta parte del código está simplificada para no usar la API)
